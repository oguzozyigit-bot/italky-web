...
async function loadFullLangPoolModule() {
  try {
    ...
    console.warn("[TURAN] /js/lang_pool_full.js yüklenemedi, fallback kullanılacak", e);
    return {};
  }
}
...
function currentBotLang() {
  return langFromPool(TURAN_LANG_POOL, state.botLang);
}
...
function renderLangLists() {
  ...
  renderLangList(UI.listBot, TURAN_LANG_POOL, state.botLang, "bot");
}
...
function latinizeCyrillicTurkic(text) {
  const map = {
    "А":"A","а":"a","Ә":"Ä","ә":"ä","Б":"B","б":"b","В":"V","в":"v","Г":"G","г":"g",
    "Ғ":"Ğ","ғ":"ğ","Д":"D","д":"d","Е":"E","е":"e","Ё":"Yo","ё":"yo","Ж":"J","ж":"j",
    "З":"Z","з":"z","И":"İ","и":"i","Й":"Y","й":"y","К":"K","к":"k","Қ":"Q","қ":"q",
    "Л":"L","л":"l","М":"M","м":"m","Н":"N","н":"n","Ң":"Ñ","ң":"ñ","О":"O","о":"o",
    "Ө":"Ö","ө":"ö","П":"P","п":"p","Р":"R","р":"r","С":"S","с":"s","Т":"T","т":"t",
    "У":"U","у":"u","Ұ":"U","ұ":"u","Ү":"Ü","ү":"ü","Ф":"F","ф":"f","Х":"H","х":"h",
    "Һ":"H","һ":"h","Ц":"Ts","ц":"ts","Ч":"Ç","ч":"ç","Ш":"Ş","ш":"ş","Щ":"Ş","щ":"ş",
    "Ъ":"","ъ":"","Ы":"I","ы":"ı","І":"İ","і":"i","Ь":"","ь":"","Э":"E","э":"e",
    "Ю":"Yu","ю":"yu","Я":"Ya","я":"ya"
  };
...
function latinizeUyghur(text) {
  const map = {
    "ا":"a","ە":"e","ې":"e","ى":"i","ي":"y","و":"o","ۇ":"u","ۆ":"ö","ۈ":"ü",
    "ب":"b","پ":"p","ت":"t","ج":"j","چ":"ç","خ":"x","د":"d","ر":"r","ز":"z",
    "ژ":"j","س":"s","ش":"ş","غ":"ğ","ف":"f","ق":"q","ك":"k","گ":"g","ڭ":"ñ",
    "ل":"l","م":"m","ن":"n","ھ":"h","ۋ":"v","ئ":"","ء":"","ـ":""
  };
