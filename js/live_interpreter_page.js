...
/* ===============================
   QR HOST FLOW
   Host QR ekranı artık gerçek room'u
   kendi içinde create-room ile oluşturuyor.
================================ */
...
/* ===============================
   NFC FLOW
   Desteklenen token tipleri:
   1) tam URL  -> direkt aç
   2) room id  -> interpreter_join
   3) host code -> open/interpreter deep link
================================ */
function joinWithNfcToken(token) {
  ...
  // create-room ile üretilmiş gerçek room id ise direkt join sayfasına git
