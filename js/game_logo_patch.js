...
function patchJeton(){
  ...
  const hp=document.querySelector(".head p"); if(hp)hp.textContent="Jeton satın alma işlemini Google Play hesabınızla tamamlayabilirsiniz."; if(!document.getElementById("italkyTokenDayNote")){const d=document.createElement("div");d.id="italkyTokenDayNote";d.className="italky-token-note";d.textContent="Mevcut gün hakları bitene kadar devam eder. Yeni kural: ilk 7 gün ücretsiz; sonra her giriş günü 5 jeton ile 24 saat.";document.querySelector(".balanceCard")?.insertAdjacentElement("afterend",d);}
}
