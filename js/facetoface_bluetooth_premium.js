...
function injectPremiumUiCss() {
  ...
  style.textContent = `
    ...
    body#frameRoot.bt-premium-mode #botSection .lang-row{
      display:none!important;
      pointer-events:none!important;
    }
    ...
    body#frameRoot.bt-premium-mode .premium-bt-hint{
      ...
      background:linear-gradient(145deg,rgba(15,23,42,.84),rgba(30,64,175,.34));
    ...
    body#frameRoot.bt-premium-mode.bt-active .premium-bt-hint{
      display:none!important;
    }
    ...
    body#frameRoot.bt-premium-mode .nav-btn .label-rotate{
      writing-mode:vertical-rl!important;
      text-orientation:upright!important;
      transform:none!important;
    }

    body#frameRoot.bt-premium-mode #clearBtn{
      left:0!important;
      right:auto!important;
      border-radius:0 18px 18px 0!important;
    }

    body#frameRoot.bt-premium-mode #homeLink{
      right:0!important;
      left:auto!important;
