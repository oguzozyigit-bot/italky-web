...
<header class="premium-header" id="italkyHeader">
  ...
  <div class="user-info" id="profileBtn" title="Profil">
    <div class="uMeta">
      ...
      <!-- ✅ Jeton Nedir? link (renk jeton sayısından farklı) -->
      <a class="uJetonLink" id="jetonInfoLink" href="/pages/jeton-nedir.html">Jeton Nedir?</a>
    </div>
...
.uJetonRow{ display:flex; align-items:center; justify-content:flex-end; gap:8px; }
.uJeton{
  font-size:10px; font-weight:900; color:#a5b4fc;
  background:rgba(165,180,252,.12); padding:2px 8px; border-radius:8px;
}

/* ✅ Jeton Nedir? linki (jeton rengiyle aynı değil, ama uyumlu) */
.uJetonLink{
  font-size:10px;
  font-weight:900;
  color: rgba(192,132,252,0.95); /* #c084fc */
  text-decoration:none;
  margin-top:2px;
  letter-spacing: .2px;
}
.uJetonLink:active{ opacity:.75; }
.uJetonLink:hover{ color: rgba(165,180,252,0.95); }
...
.footer-nav{ display:flex; gap:18px; margin-bottom:8px; justify-content:center; flex-wrap:wrap; }
...
export function mountShell(options = {}) {
  ...
  // ✅ Jeton Nedir? linki profil click'ini tetiklemesin
